          ...
          <table className="w-full text-left text-xs text-zinc-650 border-collapse">
            ...
            <tbody>
              {logs.slice(0, 5).map((log) => (
                <tr key={log.id} className="border-b border-zinc-50 hover:bg-zinc-50/30 transition-colors">
                  ...
                  <td className="py-2.5 px-3 text-zinc-400 truncate max-w-[250px]">{log.detalhe}</td>
